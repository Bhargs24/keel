...
| Area | Owner | Task | Since | State |
|---|---|---|---|---|
| | | | | |

`LOCKED` in the Owner column means nobody edits, including AI sessions.
`JOINT` with two names means one task, two agreed parts, neither reviewing their own.
